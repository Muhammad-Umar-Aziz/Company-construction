...
const AboutHeader = () => {
  ...
  return (
    <div>
    <Container fluid className='services_bg_img'>
            <Row>
              <Col md={8}>
                <div className='services_basic_banner'>
                  <div className='d-flex pb-4 d-flex justify-content-center justify-content-md-start'>
                    <img src={leftline} />
                    <h1 className='text-light services_heaading_font ps-4 pt-4'>About Our Construction Company</h1>
                  </div>
                  <p className='text-light services_paragraph_font mb-5 text-center text-md-start'>
                  ...
                  <div className='d-flex justify-content-center justify-content-md-start'>
                    <Basicbutton style={buttonStyles}>GET A FREE QUOTE</Basicbutton>
                  </div>
                </div>
              </Col>
              <Col md={4} className='bg_color pt-5'>
                <div className='p-5'>
                  ...
                  <TransparentHeaderBanner  imgSrc={img2} title="Building Repairs" description="Lorem ipsum dolor sit consectetur adipiscing elit. Nullam lectus erat" />
                  <TransparentHeaderBanner  imgSrc={img3} title="Custom Design" description="Lorem ipsum dolor sit consectetur adipiscing elit. Nullam lectus erat" />
                </div>
              </Col>
            </Row>
          </Container>
