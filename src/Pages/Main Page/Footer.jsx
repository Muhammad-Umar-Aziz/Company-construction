...
const Footer = () =>{
  ...
  <div className='py-5 d-flex justify-content-center justify-content-md-start'>
    <img src={img} alt="Contact Us" />
      ...
      <input type="text" className="form-control border rounded-0 me-5 p-2 mb-4" placeholder="Name"/>
          </Col>
          <Col lg={6}>
        
          <input type="email" className="form-control border rounded-0 p-2 mb-4" placeholder="Email"/>
...
<Col md={6}>
  ...
  <div className='p-3 p-md-5'>
      <div className='d-flex mb-3 justify-content-center justify-content-md-start'>
        ...
        <p style={{ fontFamily: 'Rubik', fontWeight: '500', fontSize: '15px' }} className='pt-3 ps-3 text-center text-md-start'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
      </div>
      <div className='d-flex mb-3 justify-content-center justify-content-md-start'>
        <img src={phone} alt="Phone" />
        <p style={{ fontFamily: 'Rubik', fontWeight: '500', fontSize: '15px' }} className='pt-3 ps-3 text-center text-md-start'>+00 123 456 78</p>
      </div>
      <div className='d-flex justify-content-center justify-content-md-start'>
        <img src={mail} alt="Email" />
        <p style={{ fontFamily: 'Rubik', fontWeight: '500', fontSize: '15px' }} className='pt-3 ps-3 text-center text-md-start'>constractioninc@gmail.com</p>
      </div>
    </div>
  </Row>
</Col>
