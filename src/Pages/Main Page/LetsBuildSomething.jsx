  ...
  return (
    ...
    <Row>
        <Col md={4} className='p-5'>
            <h1 style={{ fontFamily: 'Rubik', fontWeight: '700', fontSize: '40px' }} className='pb-3 text-center text-md-start'>Let’s Build Something Together</h1>
            ...
            <Basicbutton style={buttonStyles} children={"GET IN TOUCH"}/>
            </div>
...
export default LetsBuildSomething
